package com.polarlake.webapp.edmmon.config.logging;
...
import com.polarlake.webapp.edmmon.config.WebappsProperties;
...
public final class LoggingUtils {
     ...
     * @param context a {@link LoggerContext} object.
     * @param customFields a {@link String} object.
     * @param logstashProperties a {@link WebappsProperties.Logging.Logstash} object.
     */
    public static void addLogstashTcpSocketAppender(LoggerContext context, String customFields,
                                                    WebappsProperties.Logging.Logstash logstashProperties) {
     ...
     * @param context a {@link LoggerContext} object.
     * @param customFields a {@link String} object.
     * @param properties a {@link WebappsProperties.Logging} object.
     */
    public static void addContextListener(LoggerContext context, String customFields, WebappsProperties.Logging properties) {
    ...
    private static class LogbackLoggerContextListener extends ContextAwareBase implements LoggerContextListener {
        private final WebappsProperties.Logging loggingProperties;
        private final String customFields;

        private LogbackLoggerContextListener(WebappsProperties.Logging loggingProperties, String customFields) {
